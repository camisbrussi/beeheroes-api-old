...
describe('Update Type Organization', () => {
  ...
  it("should be able to edit a organization type", async () => {
    ...
    const organizationTypeEdited = await organizationTypesRepositoryInMemory.findByName(organizationTypeEdit.name);
  ...
  it("should be able to edit a organization type name", async () => {
    ...
    const organizationTypeEdited = await organizationTypesRepositoryInMemory.findByName(organizationType.name);
